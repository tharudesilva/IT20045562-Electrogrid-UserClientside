...
<!-- Page Body -->
	...
	if (request.getParameter("name") != null)
	 ...
	 session.setAttribute("statusMsgInsert", stsMsg);
	 }
				...
				<br>
					...
					<div class="pageNav" >
						<div class="left" id="center">
			 				<input name="btnSubmit" type="submit" value="Submit" onclick="myFunction()">
			 			</div>
			 		</div>				
					</form>
			</div>
...
<%
	 out.print(session.getAttribute("statusMsgInsert"));
	%>
</div>
...
<div class="footer">
	...
	<div class="footer-content">
		...
		<div class="footer-section-about">
			...
			<h3> Our Location </h3>
			<font size="3">No 120.<br> Flower Rd, <br> Colombo 07 <br> E-Mail :- ElectroGridSL@Gmail.com 
